...
module.exports = "<div id=\"dashboard\">\n    <div class=\"container mx-auto px-3 mt-4\">\n        <div class=\"row\">\n            <div class=\"col text-center\">\n                <h1 class=\"display-4 animated fadeIn mb-3\">Dashboard</h1>\n                <div ng-show=\"$ctrl.$rootScope.alert\" class=\"alert-danger py-2 my-3 w-50 mx-auto d-block\">{{$ctrl.$rootScope.message}}</div>\n            </div>\n        </div>\n        <div class=\"row text-center mb-3\">\n            <div class=\"col hidden-md-down\"></div>\n            <div class=\"col\">\n                <div class=\"btn btn-primary btn-lg animated fadeIn\" go-click=\"auth.addgroup\">New Group</div>\n            </div>\n            <div class=\"col\">\n                <div class=\"btn btn-primary btn-lg animated fadeIn\" go-click=\"auth.joingroup\">Join Group</div>\n            </div>\n            <div class=\"col hidden-md-down\"></div>\n        </div>\n\n        <div class=\"row text-center\">\n            <div class=\"col px-0 pb-3 text-center animated fadeIn hoverMe\">\n                <div class=\"col\" go-click=\"auth.new\">\n                    <i class=\"ion-plus display-4 hidden-md-up\" go-click=\"auth.new\"></i>\n                    <i class=\"ion-plus hidden-sm-down\" style=\"font-size: 200px\" go-click=\"auth.new\"></i>\n                    <h2 class=\"hidden-sm-down\" go-click=\"auth.new\">New Group Outing</h2>\n                    <h4 class=\"hidden-md-up\" go-click=\"auth.new\">New Group Outing</h4>\n                </div>\n            </div>\n            <div class=\"col px-0 pb-3 text-center animated fadeIn hoverMe\">\n                <div class=\"col\" go-click=\"auth.matches\">\n                    <i class=\"ion-android-star-outline display-4 hidden-md-up\" go-click=\"auth.matches\"></i>\n                    <i class=\"ion-android-star-outline hidden-sm-down\" style=\"font-size: 200px\" go-click=\"auth.matches\"></i>\n                    <h2 class=\"hidden-sm-down\" go-click=\"auth.matches\">Get Group Decision!</h2>\n                    <h4 class=\"hidden-md-up\" go-click=\"auth.matches\">Get Group Decision!</h4>\n                </div>\n            </div>\n            <div class=\"col px-0 pb-3 text-center animated fadeIn hoverMe\">\n                <div class=\"col\" go-click=\"auth.likes\">\n                    <i class=\"ion-heart display-4 hidden-md-up\" go-click=\"auth.likes\"></i>\n                    <i class=\"ion-heart hidden-sm-down\" style=\"font-size: 200px\" go-click=\"auth.likes\"></i>\n                    <h2 class=\"hidden-sm-down\" go-click=\"auth.likes\">Your Personal Likes</h2>\n                    <h4 class=\"hidden-md-up\" go-click=\"auth.likes\">Your Personal Likes</h4>\n                </div>\n            </div>\n        </div>\n<!--             <div class=\"col px-0 pb-3 text-center animated fadeIn hoverMe\">\n                <div class=\"col\" go-click=\"auth.about\">\n                    <i class=\"ion-information-circled display-4 hidden-md-up\" go-click=\"auth.about\"></i>\n                    <i class=\"ion-information-circled hidden-sm-down\" style=\"font-size: 200px\" go-click=\"auth.about\"></i>\n                    <h2 class=\"hidden-sm-down\" go-click=\"auth.about\">More About SWiTHER</h2>\n                    <h4 class=\"hidden-md-up\" go-click=\"auth.about\">More About SWiTHER</h4>\n                </div>\n            </div> -->\n        <p class=\"text-center fixed-bottom\" id=\"tutorial\" go-click=\"auth.tutorial\">View Tutorial</p>\n        </div>  <!-- container -->\n        </div> <!--id wrapper-->\n";
...
var loginComponent = {
	...
	controller: ['$rootScope', '$auth', '$http', '$state', '$timeout', 'apiService', _login4.default],
	controllerAs: '$ctrl'
};
...
var loginController = function loginController($rootScope, $auth, $http, $state, $timeout, apiService) {
    ...
    ctrl.$rootScope.getUserName = function () {
        apiService.getUserName().query({ id: window.localStorage.getItem('currentUser') }).$promise.then(function (data) {
            var nameSplit = data[0].name.split(' ');
...
function apiService($resource) {
	...
	var getUserName = function getUserName() {
		return $resource('https://swither.herokuapp.com/api/user/:id', { id: "@id" });
	};
